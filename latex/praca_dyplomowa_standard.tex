...
\streszczenieang{Thesis work base on neural network usage in the problem of diagnostic signals analysis in the problem of local damage detection in mining machines. The scope contains developing new methods and their usage. }
%
...
\begin{figure}[ht]
	\centering
	\includegraphics[scale=0.9]{images/system2.pdf}
...
Skuteczność rozwiązania silnie zależy od użytej sieci. Projektowanie sieci polega na doborze tak zwanych hiperparametrów (ang. \textit{hyperparameters}). Zalicza się do nich między innymi:
\begin{itemize}
...
Wyniki eksperymentu prezentują się następująco.
